  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Pressable onPress={addVideo}>
          <View style={styles.btnContainer}>
            ...
            <Text style={styles.btnTitle}>Add From File</Text>
          </View>
        </Pressable>
      </View>
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Paste the link to your file here</Text>
        <TextInput style={styles.input} defaultValue="File link" value={video?.uri} />
      </View>
    </View>
  );
}
